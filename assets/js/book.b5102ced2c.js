...
const TYPES=[
  {id:'dubai', k:'In person', h:'The Dubai salon',
   p:'Gold &amp; Diamond Park, Building 5. Coffee, a tray, and as long as you want with it.',
...
function downloadICS(){
  ...
  const where = S.type.id==='uk' ? 'One Street Watches — United Kingdom'
              ...
              : 'One Street Watches, Gold & Diamond Park, Building 5, Dubai';
