...
const PRIMARY = [
  {t:'Browse all watches', s:'', href:'/collections/all', k:'case'},
  {t:'Ask us anything', s:'On WhatsApp, seven days', href:'#wa', k:'wa'},
  {t:'Book a viewing',  s:'Dubai, the UK or on camera', href:'/pages/book', k:'book'}
];
const NAV = [
  ...
  {t:'Watches',             href:'/collections/all'},
  {t:'Handbags',            href:'/collections/handbags'},
  {t:'Sell a watch',        href:'/pages/sell'},
  {t:'Find me a watch',     href:'/pages/sourcing'},
  {t:'Services & repairs',  href:'/pages/services'},
  {t:'Visit us',            href:'/pages/visit'},
  {t:'The community',       href:'/pages/community'},
  {t:'About One Street',    href:'/pages/about'}
];
const WANO=WA_LINK;
...
function buildShell(){
  ...
  const here={shop:'/collections/all',sell:'/pages/sell',sourcing:'/pages/sourcing',
              servicing:'/pages/services',visit:'/pages/visit',book:'/pages/book'}[page];
...
function paintSearch(){
  ...
  const row=(w,i)=>{const im=w.ims.find(x=>x.img);
    return `<a class="navlink navlink--w" href="/products/${o.w.h}">
  ...
  box.innerHTML = hits.length
    ...
    : `<div class="navgroup"><div class="t-label">No match</div>
       ...
       <a class="navwa navwa--plain" href="/pages/sourcing">Start a sourcing request</a></div>`;
}
